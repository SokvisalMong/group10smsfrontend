...
export default function Edit() {
 ...
 useEffect(() => {
   async function fetchData() {
     ...
     const response = await fetch(`https://group10smsbackend.vercel.app/admin/${params.id.toString()}`);
 ...
 async function onSubmit(e) {
   ...
   await fetch(`https://group10smsbackend.vercel.app/admin/update/${params.id}`, {
     method: "POST",
