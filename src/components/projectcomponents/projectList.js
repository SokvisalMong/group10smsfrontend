   ...
   export default function ProjectList() {
    ...
    useEffect(() => {
      async function getProjects() {
        const response = await fetch(`https://group10smsbackend-jkbr8ai6g-smong-paragoniued.vercel.app/project/`);
    ...
    async function deleteProject(id) {
      await fetch(`https://group10smsbackend-jkbr8ai6g-smong-paragoniued.vercel.app/project/delete/${id}`, {
        method: "DELETE"
      });
