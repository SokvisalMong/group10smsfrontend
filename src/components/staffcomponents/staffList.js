   ...
   export default function StaffList() {
    ...
    useEffect(() => {
      async function getStaffs() {
        const response = await fetch(`https://g10sms.herokuapp.com/staff/`);
    ...
    async function deleteStaff(id) {
      const response = await fetch(`https://g10sms.herokuapp.com/staff/${id}`);
      ...
      const iresponse = await fetch(`https://g10sms.herokuapp.com/information/staff_id/${iid}`);
      if (!iresponse.ok) {
      ...
      await fetch(`https://g10sms.herokuapp.com/information/delete/${tempInfo._id}`, {
        method: "DELETE"
      });

      await fetch(`https://g10sms.herokuapp.com/staff/delete/${id}`, {
        method: "DELETE"
      });
